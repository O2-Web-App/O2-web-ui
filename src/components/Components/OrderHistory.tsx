...
const OrderItem = ({order, uuid}: OrderItemProps) => {
    return (
        <Link href={`/purchase-history/${uuid}`}
              className={` hover:scale-[101%] hover:bg-gray-100 rounded-2xl shadow-sm`}>
            <div className="bg-white hover:bg-gray-100  rounded-2xl shadow-sm  p-5">
