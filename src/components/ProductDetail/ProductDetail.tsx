  ...
  return (
    <section>
      {isLoading ? (
        ...
        <div className="bg-card_color p-4 my-5 rounded-tr-[40px] rounded-tl-[40px] overflow-y-auto scrollbar-hide flex flex-col min-h-[500px]">
          {/* first section */}
          <div className="flex justify-between">
            ...
            <button onClick={addToWishList} className="relative">
              ...
              <FaHeart className="text-primary absolute inset-0 m-auto" />
            </button>
          </div>
          ...
          <ReadMoreMotion text={result?.description || "No Description"} />
            ...
            <div className="w-full">
              <div className="flex justify-between items-center mt-5 text-center">
                ...
                <Sheet open={isFeedbackOpen} onOpenChange={setIsFeedbackOpen}>
                  {userData?.data && (
                    <SheetTrigger>
                      <div className="rounded-[10px] p-2 bg-accent">
                        <p className="text-body text-card_color">ផ្តល់យោបល់</p>
                      </div>
                    </SheetTrigger>
                  )}
                  <SheetContent
                  ...
                  >
                    ...
                    <p className="text-body text-description my-3">
                      មតិកែលម្អរបស់អ្នកជួយយើងកែលម្អវេទិការបស់យើង។
                      តើអ្នកគិតយ៉ាងណាដែរ?
                    </p>
                    ...
                    <div className="w-full flex justify-end">
                      <SheetClose className="border text-font_description border-primary p-3 rounded-lg mr-4">
                        បោះបង់
                      </SheetClose>
                      <button
                        onClick={handleUserFeedback}
                        className="p-3 bg-primary rounded-lg text-card_color"
                      >
                        បញ្ជូនមតិកែលម្អ
                      </button>
                    </div>
              ...
              >
                <CarouselContent>
                  {result.feedbacks.map(
                    (feedback: FeedbackType, index: number) => (
          ...
          <div className="mt-auto">
            <button
              onClick={addToCart}
              className="rounded-lg mt-5 bg-primary p-4 flex justify-center items-center text-card_color text-body space-x-3 w-full"
            >
