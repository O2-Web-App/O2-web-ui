...
export default function UserProfile() {
    ...
    return (
        <div className="bg-gray-100 flex flex-col items-center">
            ...
            <div
                className="relative w-30 h-30 cursor-pointer border-4 shadow-lg border-secondary/30 rounded-full flex items-center justify-center">
            ...
            >
                <Form className="mt-6 w-11/12 md:w-1/2 space-y-3.5">
                    ...
                    <div className="flex justify-between mt-4">
                        <button onClick={popupModalChangePassword} type="button"
                                className="w-[48%] border border-secondary text-secondary py-2 rounded-lg hover:bg-secondary/10 transition">
                            ផ្លាស់ប្តូរពាក្យសម្ងាត់
                        </button>
                        <button type="submit"
                                className="w-[48%] bg-primary text-white py-2 rounded-lg hover:secondary/60 transition">
                            រក្សាទុកការកែប្រែ
                        </button>
                    </div>
                </Form>
